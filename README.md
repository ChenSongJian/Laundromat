...
## API documentation
Refer to the [postman api documentation](https://documenter.getpostman.com/view/11989182/2sA3Bt19WH) for more detailed information, you may also import the [postman collection file](./washing_machine_api.postman_collection.json) to send request to the backend server
